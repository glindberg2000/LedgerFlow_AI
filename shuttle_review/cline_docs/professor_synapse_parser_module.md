# Parser Module Source: chase_checking.py

**For: Professor Synapse — Parser-Registry Sleuth Investigation**

Below is the full source of `dataextractai/parsers/chase_checking.py` as requested. This shows:
- How the parser imports and registers itself
- All import-time code and possible exception points
...
**Notes for Professor Synapse:**
- The registration call is at the bottom: `ParserRegistry.register_parser("chase_checking", ChaseCheckingParser)`
- All imports are at the top; no obvious conditional logic or guards
- Any exception in the module (including import errors) would prevent registration
- Logger is initialized at import time

If you need additional parser modules or supporting files, let me know! 